  ...
  return function (WrappedComponent) {
    ...
    var withI18n = function (_React$Component) {
      ...
      function withI18n() {
        ...
        }, _this.checkUpdate = /* istanbul ignore next */function () {
          _this.forceUpdate();
  ...
  _createClass(I18nProvider, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (language !== prevProps.language || catalogs !== prevProps.catalogs) {
        this.linguiPublisher.update({ language: language, catalogs: catalogs });
      }
    }
  }, {
    key: 'getChildContext',
...
function formatElements(value) {
  ...
  try {
    for (var _iterator = _getIterator(getElements(parts)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      tree.push(cloneElement(elements[index], { key: index },
...
var Trans = function (_React$Component) {
  ...
  _createClass(Trans, [{
    ...
    value: function getTranslation() {
      ...
      return i18n && typeof i18n._ === 'function' ? i18n._(id, { defaults: defaults, values: values, formats: formats })
